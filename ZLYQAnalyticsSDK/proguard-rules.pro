...
-keep class com.zlyq.client.android.analytics.bean.**{*;}
-keep class com.zlyq.client.android.analytics.exception.**{*;}
-keep class com.zlyq.client.android.analytics.enums.**{*;}

-keep public class com.zlyq.client.android.analytics.ZADataManager* {
      public protected *;
}

-keep public class com.zlyq.client.android.analytics.ZADataAPI* {
     public protected *;
}
...
-keep public class com.zlyq.client.android.analytics.utils.ZLYQDataUtils* {
      public protected *;
}