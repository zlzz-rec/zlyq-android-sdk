...
public class ZlyqPoolingByteArrayOutputStream extends ByteArrayOutputStream {
    /**
     * If the {@link #ZlyqPoolingByteArrayOutputStream(ZlyqByteArrayPool)} constructor is called, this is
     * the default size to which the underlying byte array is initialized.
     */
    private static final int DEFAULT_SIZE = 256;

    private final ZlyqByteArrayPool mPool;

    /**
     * Constructs a new ZlyqPoolingByteArrayOutputStream with a default size. If more bytes are written
     * to this instance, the underlying byte array will expand.
     */
    public ZlyqPoolingByteArrayOutputStream(ZlyqByteArrayPool pool) {
     ...
     *        minimum size.
     */
    public ZlyqPoolingByteArrayOutputStream(ZlyqByteArrayPool pool, int size) {
        mPool = pool;
