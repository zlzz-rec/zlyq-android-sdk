...
public class ZlyqZlyqHttpClientStack implements ZlyqHttpStack {
    protected final HttpClient mClient;

    private final static String HEADER_CONTENT_TYPE = "Content-Type";

    public ZlyqZlyqHttpClientStack(HttpClient client) {
        mClient = client;
    }
    ...
    /* protected */ static HttpUriRequest createHttpRequest(Request<?> request,
            Map<String, String> additionalHeaders) throws ZlyqAuthFailureError {
    ...
    private static void setEntityIfNonEmptyBody(HttpEntityEnclosingRequestBase httpRequest,
            Request<?> request) throws ZlyqAuthFailureError {
