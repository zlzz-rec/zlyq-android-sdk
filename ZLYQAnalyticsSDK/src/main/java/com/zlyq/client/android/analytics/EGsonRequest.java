...
import com.zlyq.client.android.analytics.net.core.Tools.HttpHeaderParser;
...
public class EGsonRequest<T> extends Request<T> {
   ...
   private String url_log = "";
     ...
     */
    public EGsonRequest(int method, String url, Class<T> clazz, Map<String, String> headers, Map params,
