...
public abstract class Request<T> implements Comparable<Request<T>> {
    ...
    public Map addHeaderSign(String url, Map headers) {
        try {
            if (url != null) {
                ...
                String signParam = getSignParam(getUrlParams);
                headers.put("Z-Sign", signParam);
                return headers;
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    public Map addPostParams(Map params) {
       /* *//**
         * AddParams-POST
         *//*
        try {
...
//        return "application/x-www-form-urlencoded; charset=" + getParamsEncoding();
    ...
    private byte[] encodeParameters(Map params, String paramsEncoding) {
        try {
//            String str = new JSONObject(params.toString()).toString();
